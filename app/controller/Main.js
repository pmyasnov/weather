Ext.define('Weather.controller.Main', {
	...
	* Weather.utils.Functions.loadData() for loading the weather data.
	...
	*/
	 onRefresh: function() {
		...
		var model = Ext.create("Weather.model.Setting", {});
		...
		if (model.get('geo') !== true && errors.isValid() === false) {
			...
			store.sync();
			Weather.utils.Functions.loadData();
		}
